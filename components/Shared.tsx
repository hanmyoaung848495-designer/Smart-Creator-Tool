...
export const ApiKeyManager: React.FC<{
  ...
  return (
    <div className="mb-6 p-4 bg-blue-50/50 dark:bg-blue-900/20 rounded-2xl border border-blue-100 dark:border-blue-800 flex flex-col sm:flex-row items-center gap-4">
      <div className="flex items-center gap-3 shrink-0">
        <label className="text-xs font-bold text-blue-900 dark:text-blue-300 uppercase tracking-widest">API Engine:</label>
        <div className="flex bg-white dark:bg-gray-800 rounded-lg p-1 shadow-sm border border-blue-100 dark:border-gray-700">
          <button
      ...
      {session.useCustomKey && (
        <input
          ...
          className="flex-grow px-4 py-2 text-xs rounded-xl border border-blue-200 dark:border-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 dark:text-gray-100"
        />
      )}
    </div>
  );
...
export const Modal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
